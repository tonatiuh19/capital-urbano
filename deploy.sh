...
echo ""
echo "⚠️  Large brand videos are NOT in git (>100MB). Upload once to public_html/assets/videos/:"
echo "   - CapitalUrbano.mp4"
echo "   - SomosCapitalUrbano.mp4"
echo "   (capital-hero-section.mp4 is included in the build from public/assets/videos/)"
echo ""
